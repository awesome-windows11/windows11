...
Вернуть классическое меню, вызываемое правой кнопкой мыши, плюс избавиться от централизованной панели задач и помещает кнопку запуска обратно влево вместе с закрепленными элементами. **Есть баг!** Из-за настройки исчезает область времени / даты на панели задач!

![image](https://user-images.githubusercontent.com/86190960/124925074-c389a180-e004-11eb-8a4b-74e6fddb1a47.png)
