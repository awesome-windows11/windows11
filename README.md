...
| [load_anim.reg](https://awesome-windows11.github.io/windows11/load_anim.reg) <br> ![image](https://user-images.githubusercontent.com/86190960/149355280-d00369a9-766f-4758-9277-5a0dc0f7e428.png) | Включить новую анимацию загрузки |
...
| [VsCodeDefault.reg](https://awesome-windows11.github.io/windows11/vscode/vscodedefault.reg) <br> <a href="https://imgbb.com/"><img src="https://i.ibb.co/vYgZ5WH/image.png" alt="image" border="0"></a> | Сделать VScode Portable редактором по умолчанию <br> **Важно: смените путь к редактору на свой!** (по умолчанию `E:\VScode`>
